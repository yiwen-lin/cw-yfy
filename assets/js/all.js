$(function() {
  const topic = [
    {
      name: '農業循環',
      content: '永豐餘以農業副產品蔗渣製作建材和造紙，是農業循環的源起。在大陸揚州，將稻稈利用熱能、機械力與酵素，以無化學添加的生物製程，提取秸稈纖維，產出秸稈生物製漿 nPulp 做成各式綠色包材。2014年，nPulp 亦獲得鼓勵創新發明的美國「愛迪生獎」肯定。',
      svg: '<img src="./assets/images/box-1.jpg">',
    }, {
      name: '紙循環',
      ...
      svg: '<img src="./assets/images/box-2.jpg">',
    }, {
      name: '水循環',
      content: '水是造紙重要的介質，水的循環是永豐餘造紙重要的工藝，讓水在密閉系統不斷循環再生利用，建置厭氧反應系統，大幅降低製程排放水的有機物含量。一滴水必須通過物理、化學、生物處理等至少五道關卡，才能安全放流回歸大自然。',
      svg: '<img src="./assets/images/box-3.jpg">',
    }, {
      name: '再生能源循環',
      content: '永豐餘的循環經濟發展出全台最大的再生能源場域，包括全台最早、最大木質素生質能發電、全台最大厭氧沼氣發電系統，和全台第一座 SRF 零燃煤汽電共生鍋爐。',
      svg: '<img src="./assets/images/box-4.jpg">',
    }, {
      name: '碳循環',
      content: '光合作用將碳轉為有機形式固定貯存，累積形成木材組織，紙產品以農林植物纖維為原料，因此具有纖維固碳的綠色產品特性。永豐餘兩岸植林面積超過3萬公頃，從造林到造紙形成獨特的固碳產業鏈。',
      svg: '<img src="./assets/images/box-5.jpg">',
    }
  ];
